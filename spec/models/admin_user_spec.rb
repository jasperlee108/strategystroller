...
describe AdminUser do
  ...
  it "should have valid Email" do
    ...
    assert(admin.save, "Admin is valid")
  end
  ...
  it "should not have empty Email" do
    ...
    assert(!admin.save, "Email can't be blank")
  end
  ...
  it "should have valid Email" do
    ...
    assert(!admin.save, "Email is invalid: " + "a")
  end
  ...
  it "should not have empty Password" do
    ...
    assert(!admin.save, "Password can't be blank")
  end
  ...
  it "should have Password min 8 characters" do
    ...
    assert(!admin.save, "Password is too short (minimum is 8 characters)")
  end
  ...
  it "should have matching Password and Password Confirmation" do
    ...
    assert(!admin.save, "Password doesn't match confirmation")
  end
  ...
  it "should have matching Password and Password Confirmation with at least 8 characters" do
    ...
    assert(!admin.save, "Password doesn't match confirmation, Password is too short (minimum is 8 characters)")
  end
  ...
  it "should not have empty Email & Password" do
    ...
    assert(!admin.save, "Email can't be blank, Password can't be blank")
  end
  ...
  it "should not have empty Email and have Password min 8 characters" do
    ...
    assert(!admin.save, "Email can't be blank, Password is too short (minimum is 8 characters)")
  end
  ...
  it "should not have empty Email and have matching Password and Password Confirmation" do
    ...
    assert(!admin.save, "Email can't be blank, Password doesn't match confirmation")
  end
  ...
  it "should not have empty Email and have matching Password and Password Confirmation with at least 8 characters" do
    ...
    assert(!admin.save, "Email can't be blank, Password doesn't match confirmation, Password is too short (minimum is 8 characters)")
  end
  ...
  it "should have valid email and not have empty Password" do
    ...
    assert(!admin.save, "Email is invalid, Password can't be blank")
  end
  ...
  it "should have valid email and have Password min 8 characters" do
    ...
    assert(!admin.save, "Email is invalid, Password is too short (minimum is 8 characters)")
  end
  ...
  it "should have valid email and have matching Password and Password Confirmation" do
    ...
    assert(!admin.save, "Email is invalid, Password doesn't match confirmation")
  end
  ...
  it "should have valid email and have matching Password and Password Confirmation with at least 8 characters" do
    ...
    assert(!admin.save, "Email is invalid, Password doesn't match confirmation, Password is too short (minimum is 8 characters)")
  end
